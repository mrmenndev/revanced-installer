...
"https://github.com/revanced/revanced-integrations/releases/download/v0.17.0/app-release-unsigned.apk"
REVANCED_PATCHES_URL=\
"https://github.com/revanced/revanced-patches/releases/download/v2.0.3/revanced-patches-2.0.3.jar"
REVANCED_CLI_URL=\
"https://github.com/revanced/revanced-cli/releases/download/v2.0.3/revanced-cli-2.0.3-all.jar"
